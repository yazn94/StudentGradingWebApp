package com.example.studentgradingsystemservlets.Database;

import com.example.studentgradingsystemservlets.Model.Course;
import com.example.studentgradingsystemservlets.Model.Grade;
...
public class DAO {
    ...
    // SQL statements
    private static final String INSERT_STUDENT = "INSERT INTO students(firstName, lastName, age, phone) VALUES (?, ?, ?, ?)";
    ...
    private static final String ADD_GRADE = "INSERT INTO grades(studentId, courseId, grade) VALUES (?, ?, ?)";
